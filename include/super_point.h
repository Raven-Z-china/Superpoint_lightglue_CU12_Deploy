...
private:
    ...
    bool
    process_output(const tensorrt_buffer::BufferManager &buffers, Eigen::Matrix<double, 258, Eigen::Dynamic> &features, Eigen::Matrix<double, 1, Eigen::Dynamic> &features_score);
