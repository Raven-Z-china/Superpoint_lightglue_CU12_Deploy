...
def parse_arguments():
    ...
    parser.add_argument("--input", default="output/superpoint_lightglue.onnx", help="The input model file")
    parser.add_argument("--output", default="output/superpoint_lightglue_ssi.onnx", help="The output model file")
    parser.add_argument(
        "--auto_merge",
