...
class LightGlue(nn.Module):
    ...
    def forward(self, kpts0: torch.Tensor, kpts1: torch.Tensor, desc0: torch.Tensor, desc1: torch.Tensor) -> dict:
        ...
        with torch.autocast(enabled=self.conf.mp, device_type="cuda"):
            return self._forward(kpts0, kpts1, desc0, desc1)
            # return self._forward(data)

    def _forward(self, kpts0: torch.Tensor, kpts1: torch.Tensor, desc0: torch.Tensor,
                 desc1: torch.Tensor) -> torch.Tensor:
